...
//    private static final String TEST_EMAIL = "saitbaevlatif@gmail.com";
...
//            throws IOException {
//        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(Objects.requireNonNull(GMailer.class.getResourceAsStream("/secret.json"))));
//
...
//
//        try {
//            msg = service.users().messages().send("1006062864802-4pbob0kod4chk9udoc8uufn7ecfg80vq.apps.googleusercontent.com", msg).execute();
