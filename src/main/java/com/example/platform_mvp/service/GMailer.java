...
//            throws IOException {
//        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory, new InputStreamReader(Objects.requireNonNull(GMailer.class.getResourceAsStream("/client_secret_1006062864802-8ur7dh3qil0rpc7m8anoe9ucesj2lscq.apps.googleusercontent.com.json"))));
//
//        log.info("Secret of client" + clientSecrets.toPrettyString());
//
